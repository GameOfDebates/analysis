...
first_file_edited = open('rep-12-15-2015.txt', 'w')
...
second_file_edited = open('rep_1-14-2016.txt', 'w')
...
third_file_edited = open('rep_1-28-2016.txt', 'w')
...
fourth_file_edited = open('rep_2-6-2016.txt', 'w')
...
fifth_file_edited = open('rep_2-13-2016.txt', 'w')
...
sixth_file_edited = open('rep_2-25-2016.txt', 'w')
...
seventh_file_edited = open('rep_3-3-2016.txt', 'w')
...
eighth_file_edited = open('rep_3-10-2016.txt', 'w')
